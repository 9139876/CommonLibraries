...
using CommonLibraries.BackgroundWorker.Models;

namespace CommonLibraries.BackgroundWorker.Controllers
{
    public class BackgroundWorkerApiController : Controller
    {
        ...
        public virtual PingApiResponse Ping()
        {
            ...
            foreach (var iWorker in workers)
            {
                ...
                var newWorker = new BackgroundWorkerPingModel
                {
                    ...
                    LogIterationRetries = backgroundWorker.LogIterationRetries,
                    IterationRetryDelayInMillisecondsStart = backgroundWorker.IterationRetryDelayInMillisecondsStart,
                    IterationRetryDelayInMillisecondsEnd = backgroundWorker.IterationRetryDelayInMillisecondsEnd,
                    IterationRetryCount = backgroundWorker.IterationRetryCount
                };
        ...
        [Microsoft.AspNetCore.Mvc.Route("api/backgroundworker/start")]
        ...
        [Microsoft.AspNetCore.Mvc.HttpPost]
        [Microsoft.AspNetCore.Mvc.Route("api/backgroundworker/stop")]
